    ...
    >
      <div className="w-full max-w-2xl bg-[#0a0a0a] border border-white/10 p-6 sm:p-8 rounded-2xl sm:rounded-3xl relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl sm:text-5xl font-black italic uppercase tracking-tighter skew-x-[-6deg] underline decoration-[#ff2e63] decoration-[4px] sm:decoration-8">Game Rooms</h2>
          <p className="text-[10px] uppercase tracking-[0.3em] font-medium text-white/30 mt-2">Browse available games to join</p>
        </div>
        ...
        <div className="space-y-3 overflow-y-auto max-h-[50vh] pr-2 custom-scrollbar min-h-[200px]">
          {loading ? (
             <div className="h-[200px] flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-[10px] uppercase font-black text-white/20 tracking-tighter">Looking for games...</p>
             </div>
          ) : rooms.length === 0 ? (
            <div className="h-[200px] flex flex-col items-center justify-center gap-4 border-2 border-dashed border-white/5 rounded-2xl">
              <p className="text-[10px] uppercase font-black text-white/20 tracking-tighter">No games found</p>
              <button 
                onClick={onClose}
              ...
              >
                ...
                <div className="flex items-center gap-4 sm:gap-8">
                  <div className="text-right">
                    ...
                    <p className="text-[8px] uppercase font-black text-white/20">Players</p>
                  </div>
                  <button 
